...
<head>
    ...
    <title><?php echo h($pageTitle ?? 'Admin | KMA'); ?></title>
    <script>
        try {
...
<body class="bg-kma-bg dark:bg-gray-900 min-h-screen">
    ...
    <!-- Top bar -->
    <header class="fixed top-0 left-0 right-0 z-50 h-[60px] bg-gradient-to-r from-accent to-[#1a4a2a] shadow-lg flex items-center">
        <div class="flex items-center justify-between w-full px-4">
            <!-- Left -->
            <div class="flex items-center gap-3">
                <button id="sidebarToggle"
                    class="text-white/80 hover:text-white w-9 h-9 rounded-lg hover:bg-white/10 flex items-center justify-center transition-colors lg:hidden"
                    aria-label="মেনু">
            ...
            <div class="flex items-center gap-2">
                ...
                <div class="relative" id="userMenuWrap">
                    <button id="userMenuBtn"
                        class="flex items-center gap-2 bg-white/15 hover:bg-white/25 transition-colors rounded-lg px-3 py-1.5">
                    ...
                    <div id="userMenuDrop"
                        class="hidden absolute right-0 top-full mt-1.5 w-44 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-kma-border dark:border-gray-700 overflow-hidden z-50">
                        ...
                        <a href="<?php echo BASE_URL; ?>/admin/logout.php"
                            class="flex items-center gap-2 px-4 py-2.5 text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors border-t border-kma-border dark:border-gray-700">
    ...
    <aside id="adminSidebar"
        class="fixed top-[60px] left-0 bottom-0 w-56 bg-white dark:bg-gray-900 border-r border-kma-border dark:border-gray-800 z-40 overflow-y-auto
              -translate-x-full lg:translate-x-0 transition-transform duration-200">
        <nav class="p-3 space-y-0.5">
            <?php foreach ($navItems as $item): ?>
                <a href="<?php echo h($item[1]); ?>"
                    class="sidebar-link <?php echo $currentAdminPage === $item[0] ? 'active' : ''; ?>">
            ...
            <a href="<?php echo BASE_URL; ?>/admin/logout.php"
                class="sidebar-link text-red-500 hover:!bg-red-600 hover:!text-white">
            ...
            <script>
                (function() {
                    ...
                    document.addEventListener('click', function() {
                        if (udrop) udrop.classList.add('hidden');
                    });
                })();
            </script>
